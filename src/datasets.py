...
def get_dataset(data_dir: str = "/data", name: str = "MNISTSuperpixels", pre_transforms: base_transform = None,
    transforms: base_transform = None, valid_ratio: float = 0.1) -> Tuple[Dataset, Dataset, Dataset]:
    '''
